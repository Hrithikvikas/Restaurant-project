...
module.exports= class Customer{
    ...
    static add_order(cart_rows){
        ...
        cart_rows.forEach(function(c_row) {
            pool.query('insert into orders_contents_online(order_id,recipe_id,quantity) values($1,$2,$3) on conflict (user_id,item_id) do update set quantity=orders.quantity+excluded.quantity;',[c_row.user_id,c_row.item_id,c_row.quantity]);
        })
    ...
    static empty_cart(){
        return pool.query('delete from cart where user_id=1;');
    }
